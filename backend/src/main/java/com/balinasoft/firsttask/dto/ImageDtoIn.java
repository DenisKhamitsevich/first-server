...
public class ImageDtoIn {
    ...
    @ApiModelProperty(required = false, notes = "Unix Timestamp. 1900-01-01 - 2999-12-31", dataType = "java.lang.Long", example = "1262307723")
    ...
    @ApiModelProperty(required = true, notes = "Image categories")
